...
"</div>" +
	...
	div.innerHTML += "&nbsp;&nbsp;B:&nbsp;<span name=\"" + divId + "-balance\" id = \"" + divId + "-balance\" style=\"CURSOR: pointer;\" onclick=\"calculateBalance('" + divId + "')\"></span><span style=\"float:right;\">&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"javascript:void(null)\" onclick=\"removeTr("+divId+");xajax_addUnbilled("+divId+")\"><?echo $locate->Translate("Refresh");?></a>&nbsp;</span>";
	divContainer.appendChild(div);
