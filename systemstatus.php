...
"</div>" +
	...
	var div = document.createElement("div");
	div.className = "lable";
	div.innerHTML += "&nbsp;&nbsp;<span title='<?php echo $locate->Translate("Unbilled");?>'>xC:</span>&nbsp;<span id=\""+divId+"-unbilled\"  title='<?php echo $locate->Translate("Unbilled");?>'>0</span>";
	div.innerHTML += "&nbsp;&nbsp;<span title='<?php echo $locate->Translate("Billed");?>'>C:</span>&nbsp;<span  title='<?php echo $locate->Translate("Billed");?>' name=\"" + divId + "-balance\" id = \"" + divId + "-balance\" style=\"CURSOR: pointer;\" onclick=\"calculateBalance('" + divId + "')\"></span><span style=\"float:right;\">&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"javascript:void(null)\" onclick=\"removeTr("+divId+");xajax_addUnbilled("+divId+")\"><?php echo $locate->Translate("Refresh");?></a>&nbsp;</span>";
	divContainer.appendChild(div);
	...
	if(customereable != 0){
		...
		var div = document.createElement("div");
		div.className = "lable";	
		div.innerHTML += "&nbsp;<span id=\"" + divId + "-spanCustomers\"><?php echo $locate->Translate("Member");?></span>: <input id=\"" + divId + "-CustomerName\" name=\"" + divId + "-CustomerName\" type=\"text\" value=\"\" size=\"15\" maxlength=\"20\">";	
...
function appendTr(tbodyId,aryValues){
	...
	//tr.setAttribute("ondblclick", "if (confirm('<?php echo $locate->Translate("are you sure to re-calculate the credit");?>'))  xajax_reCalculate('"+tbodyId.substring(0,tbodyId.length-14)+"','"+aryValues["billsec"]+"','"+aryValues["rate"]+"');return false;"); //.toString()
	...
	<body onload="init();">
		...
		<div id="divPanel" name="divPanel" class="divPanel" style="z-index:999;">
			...
			<?php if($config['system']['sysstatus_new_window'] == 'yes') $target='_blank'?>
                                <li><a href="manager_profile.php" target="<?php echo $target ?>"><?php echo $locate->Translate("Profile");?></a></li>
				<li><a href="rate.php" target="<?php echo $target ?>"><?php echo $locate->Translate("Rate");?></a></li>
				<li><a href="checkout.php" target="<?php echo $target ?>"><?php echo $locate->Translate("Report");?></a></li>
				<li><a href="clid.php" target="<?php echo $target ?>"><?php echo $locate->Translate("Clid");?></a></li>
                                <li><a href="cdr.php" target="<?php echo $target ?>"><?php echo $locate->Translate("Cdr");?></a></li>
				<li><a href="curcdr.php" target="<?php echo $target ?>"><?php echo $locate->Translate("Curcdr");?></a></li>
				<li><a href="manager_login.php" onclick="return confirm('<?php echo $locate->Translate("are you sure to exit");?>');"><?php echo $locate->Translate("Log Out");?></a></li>
			</ul>
		</div>
		...
		&nbsp;<?php echo $locate->Translate("Last Refresh Time");?>: <span id="spanLastRefresh" name="spanLastRefresh"></span>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $locate->Translate("Limit Status");?>:&nbsp;<span id="spanLimitStatus" name="spanLimitStatus"></span><br>
		<input type="button" value="<?php echo $locate->Translate("Callshop Status");?>" onclick="showCallshopStatus();">

		<div id="divAmount" style="display:none;">
		&nbsp;<?php echo $locate->Translate("Amount");?>:&nbsp;<span id="spanAmount" name="spanAmount"></span>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $locate->Translate("Cost");?>:&nbsp;<span id="spanCost" name="spanCost"></span>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $locate->Translate("Limit");?>:&nbsp;<span id="spanLimit" name="spanLimit"> </span>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $locate->Translate("Current Credit");?>:&nbsp;<span id="spancurcredit" name="spancurcredit"></span>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $locate->Translate("Available Balance");?>:&nbsp;<span id="spanbalance" name="spanbalance"></span><br>
		</div>
		<div>
				<input type="text" size="10" name="iptSearchRate" id="iptSearchRate">
				<select id="searchRateType" name="searchRateType">
					<option value="prefix"><?php echo $locate->Translate("Prefix");?></option>
					<option value="dest"><?php echo $locate->Translate("Destination");?></option>
				</select>
				<input type="button" value="<?php echo $locate->Translate("Search Rate");?>" onclick="searchRate();">
