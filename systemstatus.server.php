...
$myAsterisk->sendText($peerstatus[$peer]['srcchan'],"Costo:".astercc::creditDigits($peerstatus[$peer]['credit']));
				} else {
					$msg .= "E";
				}*/
		}
...
//			print $res->numRows();
	...
	$objResponse->addAssign("spanLastRefresh",'innerHTML',$msg.date ("Y-m-d H:i:s",time()));
	return $objResponse;
}
