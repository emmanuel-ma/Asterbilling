...
function checkoutAll()
{
	...
	<body onload="init();" id="report">
		...
		<center>
			...
			<input type="button" value="<?echo $locate->Translate("Check Out")?>" name="btnCheckOut" id="btnCheckOut" onclick="xajax_checkOut(xajax.getFormValues('f'));">
		</div>
		</center>
	<div id="divMsg">
		<?echo $locate->Translate("Processing please wait")?> ...
	</div>
